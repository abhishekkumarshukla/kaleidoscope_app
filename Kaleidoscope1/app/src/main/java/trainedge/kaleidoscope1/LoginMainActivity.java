package trainedge.kaleidoscope1;
...
public class LoginMainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Snackbar.make(btnGoogleSignin,"Not connected to Internet", BaseTransientBottomBar.LENGTH_INDEFINITE).show();
    }
